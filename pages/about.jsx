	...
	return (
		<section className={clsx(styles.about)}>
			...
			<Card
				...
				imgSrc={
					'https://images.unsplash.com/photo-1676752528061-fdf5bffd595c?q=80&w=1635&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
				}
				txt={'Post Title'}
			/>
		</section>
